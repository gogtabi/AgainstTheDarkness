...
public class ItemBucket extends Item
{
    ...
    public ItemBucket(Block containedBlock, String unlocalizedName) {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
        ...
        ItemStack itemStackIn = this.getDefaultInstance();
    ...
    public net.minecraftforge.common.capabilities.ICapabilityProvider initCapabilities(ItemStack stack, net.minecraft.nbt.NBTTagCompound nbt) {
        if (this.getClass() == ItemBucket.class)
        {
            ...
            {
                return new net.minecraftforge.fluids.capability.wrappers.FluidBucketWrapper(stack); // when fluid container registry is gone, just use FluidBucketWrapper
            }
        }
        else
        {
